...
public class Gallepackages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gallepackages);
        ...
        process.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Gallepackages.this, PHMainActivity.class);
    ...
    private void sendMessage() {
        ...
        final ProgressDialog dialog = new ProgressDialog(Gallepackages.this);
