...
public class Riverstonpackages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_riverstonpackages);
        ...
        process.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Riverstonpackages.this, PHMainActivity.class);
    ...
    private void sendMessage() {
        ...
        final ProgressDialog dialog = new ProgressDialog(Riverstonpackages.this);
