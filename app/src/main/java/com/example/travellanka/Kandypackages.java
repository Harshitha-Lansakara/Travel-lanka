...
public class Kandypackages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kandypackages);
        ...
        process.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Kandypackages.this, PHMainActivity.class);
    ...
    private void sendMessage() {
        ...
        final ProgressDialog dialog = new ProgressDialog(Kandypackages.this);
